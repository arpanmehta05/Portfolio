  ...
  const projectData = [
    {
      ...
      githubLink: "https://github.com/yourusername/aichess",
    ...
    },
    {
      ...
      githubLink: "https://github.com/yourusername/study-notion",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mt-4 max-w-2xl mx-auto">
            Here are some of my major projects that showcase my skills in full-stack development and problem-solving.
          </p>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {projectData.map((project, index) => (
            <div key={index} className="bg-black text-white rounded-2xl p-8 hover:scale-105 transition-transform duration-300">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, techIndex) => (
                      <span key={techIndex} className="px-3 py-1 bg-white/10 text-white text-sm rounded-full">
                        {tech}
                      </span>
                    ))}
                  </div>
